...
- **Plugin manifest:** `markdown-html-skills` plugin.json `skills` array now lists 5 paths (orchestrator + design-system + md-document + md-review + md-slides). Marketplace counters updated (trued up 2026-06-10 via `scripts/derive_counters.py`): 77 plugins, 17 domains, **344 skills**, **579 Python tools**, **698 references**, **99 slash commands**.
...
**Version:** v2.10.3
**Status:** 344 skills deployed across 17 domains, 77 marketplace plugins, docs site live (counters derived via `scripts/derive_counters.py`)
